...
SOURCE PHOTO
↓
SOURCE-INFORMED + ROBOT-DREAMS-CONSTRAINED
GLOBAL PALETTE INTERPRETATION
↓
ONE LIMITED SHARED POSTER PALETTE
↓
Reality   photographic palette expression
30%       source-near palette reinterpretation + Representational Transformation
65%       strong palette regrouping + Structural Reconstruction
90%       aggressive palette compression + Symbolic Reduction
↓
