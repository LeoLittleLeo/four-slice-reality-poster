...
- For human-dominant slices, prioritize shape reduction, contour-focused line abstraction, color blocking, and painterly support. Use geometry sparingly and mainly at high abstraction.
- For architecture-dominant slices, prioritize line work, colored sketch, color blocking, source-derived geometry, painterly masses, and controlled fragmentation.
- For landscape or environment, use painterly abstraction, color blocks, shape reduction, lines, and spatial planes to create atmospheric fields and directional masses.
