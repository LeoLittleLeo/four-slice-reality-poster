...
Keep the four-slice structure perceptible through the dominant treatment in each slice core, never through drawn dividers, gutters, rectangular masks, or split-screen seams. Different media and shifting perspective are acceptable, but preserve semantic continuity where important subjects cross boundaries. Unify the poster with shared palette, repeated lines, silhouette echoes, directional rhythm, recurring textures, and shape relationships. Follow [seamless-transitions.md](seamless-transitions.md) for all three boundaries and favor cohesion over maximizing techniques.
